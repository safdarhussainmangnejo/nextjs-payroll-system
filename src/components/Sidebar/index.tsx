    ...
    menuItems: [
      {
        icon: (
          ...
          //   />
          // </svg>
          <img width="32" height="32" src="https://img.icons8.com/puffy-filled/32/inbox.png" alt="inbox"/>
        ),
        label: "HOME", // Dashboad
        route: "#",
      ...
      // },
      {
        ...
        route: "#",
        children: [
          { icon: (<img width="25" height="25" src="https://img.icons8.com/glyph-neue/64/upload-to-ftp.png" alt="upload-to-ftp"/>), label: "Request Schedule", route: "/schedule/request-schedule" },
          { icon: (<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 50 50">
            ...
            </svg>), label: "Schedule Tutor", route: "/schedule/schedule-tutor" },
          { icon: (<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 50 50">
            <path d="M 25 2 C 12.309295 2 2 12.309295 2 25 C 2 37.690705 12.309295 48 25 48 C 37.690705 48 48 37.690705 48 25 C 48 12.309295 37.690705 2 25 2 z M 25 4 C 36.609824 4 46 13.390176 46 25 C 46 36.609824 36.609824 46 25 46 C 13.390176 46 4 36.609824 4 25 C 4 13.390176 13.390176 4 25 4 z M 24.984375 6.9863281 A 1.0001 1.0001 0 0 0 24 8 L 24 22.173828 A 3 3 0 0 0 22 25 A 3 3 0 0 0 22.294922 26.291016 L 16.292969 32.292969 A 1.0001 1.0001 0 1 0 17.707031 33.707031 L 23.708984 27.705078 A 3 3 0 0 0 25 28 A 3 3 0 0 0 28 25 A 3 3 0 0 0 26 22.175781 L 26 8 A 1.0001 1.0001 0 0 0 24.984375 6.9863281 z"></path>
            </svg>), label: "Schedule Mentor", route: "/schedule/schedule-mentor" },
        ],
      },
      {
        icon: (
        ...
        route: "#",
        children: [
          { label: "Bonus Mentor", route: "/dashboard-mentor/bonus-mentor" },
          { label: "Daftar Hadir", route: "/dashboard-mentor/daftar-hadir" },
          { label: "Evaluas Mentor", route: "/dashboard-mentor/evaluas-mentor" },
        ],
      },
      {
        icon: (
        ...
        route: "#",
        children: [
          { label: "Presensi", route: "/dashboard-tutor/presensi" },
          { label: "Evaluas Tutor", route: "/dashboard-tutor/evaluas-tutor" },
        ],
      },

      {
        ...
        route: "#",
        children: [
          { label: "Student Account", route: "/settings/student-account" },
          { label: "Session & Packages Data", route: "/settings/session-packages-data" },
          { label: "Class Data", route: "/settings/class-data" },
