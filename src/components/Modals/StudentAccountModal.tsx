        ...
        <div className="relative w-full max-w-md mx-auto">
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <form className="relative flex-auto p-6">
              <div className="mb-4">
                <label htmlFor="name" className="block text-sm font-medium text-gray-700">Package</label>
                <input
                  type="text"
                  name="name"
                  id="name"
                  placeholder="Write Down Package Name"
              ...
              <div className="mb-6">
                <label htmlFor="email" className="block text-sm font-medium text-gray-700">Session Quantity</label>
                <input
                  type="email"
                  name="email"
                  id="email"
                  placeholder="Write Down Session Quantity"
                  className="mt-1 block w-full px-4 py-2 text-sm text-gray-700 bg-white border border-gray-300 rounded-md focus:border-blue-500 focus:outline-none focus:ring focus:ring-blue-500 focus:ring-opacity-50"
                />
              </div>

              <div className="mb-6">
                <label htmlFor="email" className="block text-sm font-medium text-gray-700">Package Quantity</label>
                <input
                  type="email"
                  name="email"
                  id="email"
                  placeholder="Write Down Package Quantity"
                  className="mt-1 block w-full px-4 py-2 text-sm text-gray-700 bg-white border border-gray-300 rounded-md focus:border-blue-500 focus:outline-none focus:ring focus:ring-blue-500 focus:ring-opacity-50"
                />
              </div>
