...
const SessionPackageData: React.FC = () => {
  ...
  return (
    <>
      ...
      <CustomTable
        columns={columnsSessionPackageData}
        rows={rowsSessionPackageData}
        tableType={DocumentCategoryEnum.SessionPackageData}
      />
    </>
  );
};

export default SessionPackageData;